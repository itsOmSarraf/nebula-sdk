...
```bash poetry
poetry add nebula-sdk
```

```bash conda
conda install -c conda-forge nebula-sdk
```
...
Check out complete examples in our [GitHub repository](https://github.com/0glabs/nebula-sdk-python/tree/main/examples):

- [Basic Usage](https://github.com/0glabs/nebula-sdk-python/blob/main/examples/basic_usage.py)
- [Streaming Chat](https://github.com/0glabs/nebula-sdk-python/blob/main/examples/streaming_chat.py)
- [Advanced Memory](https://github.com/0glabs/nebula-sdk-python/blob/main/examples/advanced_memory.py)
- [Multi-Agent System](https://github.com/0glabs/nebula-sdk-python/blob/main/examples/multi_agent.py)
- [Web Integration](https://github.com/0glabs/nebula-sdk-python/blob/main/examples/web_integration.py)

## Community and Support

- **Documentation**: [https://docs.0g.ai](https://docs.0g.ai)
- **GitHub**: [https://github.com/0glabs/nebula-sdk-python](https://github.com/0glabs/nebula-sdk-python)
